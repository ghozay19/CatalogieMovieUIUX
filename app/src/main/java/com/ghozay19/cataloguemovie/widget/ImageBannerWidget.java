...
public class ImageBannerWidget extends AppWidgetProvider {
    public static final String TOAST_ACTION = "com.ghozay19.cataloguemovieui_ux.TOAST_ACTION";
    public static final String EXTRA_ITEM = "com.ghozay19.cataloguemovieui_ux.EXTRA_ITEM";
    ...
    //melakukan proses broadcast saat salah satu widget ditekan
    @Override
